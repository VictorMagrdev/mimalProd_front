  ...
  <UModal :model-value="props.isOpen" @update:model-value="closeModal">
    <UCard>
      ...
      <UForm v-else :state="state" class="space-y-4" @submit="onSubmit">
        ...
        /></UFormGroup>
        <UFormGroup label="N° Línea" name="numeroLinea"
          ><UInput v-model.number="state.numeroLinea" type="number"
        /></UFormGroup>
        <UFormGroup label="Producto Componente" name="idProductoComponente"
          ><USelectMenu
        ...
        /></UFormGroup>
        <UFormGroup label="Cantidad Requerida" name="cantidadRequerida"
          ><UInput v-model.number="state.cantidadRequerida" type="number"
        /></UFormGroup>
        <UFormGroup label="Unidad Componente" name="idUnidadComponente"
          ><USelectMenu
        ...
        /></UFormGroup>
        <UFormGroup label="Observaciones" name="observaciones"
