...
>("costos-material", async () => {
  const { data } = await useFetch<ReporteCostoMaterialDTO[]>(
    "https://three-assured-ian-impressive.trycloudflare.com/api/reportes/costos/material",
    {
      method: "GET",
      headers: {
...
const handleExportPDF = async (): Promise<void> => {
  try {
    await exportState.descargarArchivo(
      "https://three-assured-ian-impressive.trycloudflare.com/api/reportes/costos/material/pdf",
...
const handleExportCSV = async (): Promise<void> => {
  try {
    await exportState.descargarArchivo(
      "https://three-assured-ian-impressive.trycloudflare.com/api/reportes/costos/material/csv",
