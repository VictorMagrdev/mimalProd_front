  ...
  async () => {
    const path =
      groupBy.value === "mensual"
        ? "https://obvolutive-angelica-nonnotably.ngrok-free.dev/api/dashboard/costos/serie-mensual"
        : "https://obvolutive-angelica-nonnotably.ngrok-free.dev/api/dashboard/costos/serie";
