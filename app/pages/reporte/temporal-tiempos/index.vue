  ...
  async () => {
    const path =
      groupBy.value === "mensual"
        ? "https://three-assured-ian-impressive.trycloudflare.com/api/dashboard/tiempos/serie-mensual"
        : "https://three-assured-ian-impressive.trycloudflare.com/api/dashboard/tiempos/serie";
