...
- **Lenguaje:** TypeScript.
- **Comunicación API:** **Apollo Client** (`@nuxtjs/apollo`) se utiliza para consumir la API GraphQL del backend. La configuración en `nuxt.config.ts` apunta a `http://localhost:8080/graphql`.
